      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 text-gray-800">
            Entradas Destacadas de la Enciclopedia
          </h2>
          <p className="text-xl text-center text-gray-600 mb-16 max-w-3xl mx-auto">
            Conoce los lenguajes y estándares más usados para estructurar la web
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="rounded-xl overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-xl">
                ...
                <div className="p-6 bg-white">
                  <p className="text-gray-600 mb-4">
                    Explore the revolutionary computing paradigm that leverages
                    quantum mechanics to perform complex calculations.
                  </p>
                  <span className="text-cyan-600 font-medium group-hover:text-cyan-700 flex items-center">
            ...
            <Link href="/encyclopedia/2" className="group">
              <div className="rounded-xl overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-xl">
                ...
                <div className="p-6 bg-white">
                  <p className="text-gray-600 mb-4">
                    Discover how machines are programmed to think and learn like
                    humans, revolutionizing our world.
                  </p>
                  <span className="text-cyan-600 font-medium group-hover:text-cyan-700 flex items-center">
                    Read more <ArrowRight className="ml-2 h-4 w-4" />
                  </span>
            ...
            <Link href="/encyclopedia/3" className="group">
              <div className="rounded-xl overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-xl">
                ...
                <div className="p-6 bg-white">
                  <p className="text-gray-600 mb-4">
                    Learn about the long-term shifts in temperatures and weather
                    patterns affecting our planet.
                  </p>
                  <span className="text-cyan-600 font-medium group-hover:text-cyan-700 flex items-center">
                    Read more <ArrowRight className="ml-2 h-4 w-4" />
                  </span>
          ...
          <div className="text-center mt-12">
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-blue-900 via-indigo-700 to-sky-500 opacity-90"
            >
              <Link href="/encyclopedia">
                Explora las entradas <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </div>
        </div>
